...
function getId($conn, $query, $value)
{
    $sql = "SELECT $query(id) AS $value FROM characters;";
...
$min_id = getId($conn, "MIN", "min_id"); // Get the lowest id number
$max_id = getId($conn, "MAX", "max_id"); // Get the highest id number
